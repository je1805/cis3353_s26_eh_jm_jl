...
├── .env                            # Active environment variables (IPs, passwords)
├── .env.example                    # Template for environment configuration
├── .gitignore                      # Files to exclude from Git version control
├── docker-compose.yml              # Main orchestration file for all 6 containers[cite: 1]
├── LICENSE                         # Project license terms[cite: 1]
├── README.md                       # Main project documentation (this file)[cite: 1]
│
├── configs/                        # Configuration files for security tools[cite: 1]
│   ├── firewall/                   # iptables and baseline rules[cite: 1]
│   │   └── default-rules.sh        # Default firewall rule definitions[cite: 1]
│   ├── ssl/                        # TLS certificates for SIEM components[cite: 1]
│   │   ├── root-ca.pem             # Root Certificate Authority[cite: 1]
│   │   ├── indexer.pem             # Wazuh Indexer certificate[cite: 1]
│   │   └── dashboard.pem           # Wazuh Dashboard certificate[cite: 1]
│   └── wazuh/                      # Wazuh manager and analysis configs[cite: 1]
│       ├── decoders/               # Custom log decoders (local_decoder.xml)[cite: 1]
│       ├── rules/                  # Custom detection rules (local_rules.xml)[cite: 1]
│       ├── ossec-manager.conf      # Main SIEM engine configuration[cite: 1]
│       └── opensearch-dashboards.yml# Dashboard-to-indexer connectivity[cite: 1]
│
├── docker/                         # Dockerfiles for custom container builds[cite: 1]
│   ├── firewall/                   # Alpine-based firewall gateway[cite: 1]
│   │   └── web-ui/                 # PHP-based firewall management dashboard[cite: 1]
│   ├── jokopi/                     # Vulnerable coffee shop application[cite: 1]
│   │   └── vulnerable-api/         # SQLi and XSS target endpoints[cite: 1]
│   ├── kali/                       # Attacker toolkit container[cite: 1]
│   ├── wazuh-dashboard/            # Custom SIEM visualization container[cite: 1]
│   └── wazuh-manager/              # Custom SIEM engine container[cite: 1]
│
├── docs/                           # Technical documentation and guides[cite: 1]
│   └── DEPLOYMENT_GUIDE.md         # Full environment setup instructions[cite: 1]
│
├── evidence/                       # Verified attack and defense artifacts[cite: 1]
├── reports/                        # Final project reports and presentations[cite: 1]
│
├── scripts/                        # Automation and operational scripts[cite: 1]
│   ├── active-response/            # Automated IP blocking and handling[cite: 1]
│   ├── attacks/                    # Numbered attack scenarios (01-06)[cite: 1]
│   └── setup/                      # Environment and GitHub initialization[cite: 1]
│       ├── generate-certs.sh       # SSL generation script[cite: 1]
│       ├── lab-setup.sh            # Complete lab initialization[cite: 1]
│       ├── create_github_workflow.ps1# GitHub Actions automation[cite: 1]
│       └── assign_issues.ps1       # Automated GitHub Project management[cite: 1]
│
└── GitHub Guide/                   # Agile and project management records[cite: 1]
    ├── IMPLEMENTATION_PLAN.md      # Sprint and milestone breakdown[cite: 1]
    ├── PROJECT_RETROSPECTIVE.md    # Lessons learned and incident ledger[cite: 1]
    └── SECURITY_CLEANUP.md         # Post-project decommissioning guide[cite: 1]
```
...
- Emily Hernandez - Project Lead
- Jediah Mayberry - System Architect
- Jeraldhin Leon - Security Analyst
